...
htmlhelp_basename = 'sw-easycreditdoc'
...
latex_documents = [
    (master_doc, 'sw-easycredit.tex', u'easyCredit-Rechnung & Ratenkauf für Shopware 5.x',
...
man_pages = [
    (master_doc, 'sw-easycredit', u'easyCredit-Rechnung & Ratenkauf für Shopware 5.x',
     [author], 1)
]
